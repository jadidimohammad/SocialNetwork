...
<button name="login" class="btn_login" onclick="cambiar_login()" >LOGIN</button>
</form>
  </div>
...
<input type="text" name="u_name" placeholder="Enter your name" required="required" />
     ...
     <input type="email" name="u_email" placeholder="Enter your mail" required="required"/> 
...
<button name="sign_up" class="btn_sign_up" onclick="cambiar_sign_up()">SIGN UP</button>
				<?php 
