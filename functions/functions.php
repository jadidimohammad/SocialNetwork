<?php 
	...
	while($row_posts=mysqli_fetch_array($run_posts)){
		...
		<h4> $post_date </h4>
		<p> $content </p>
		<a href='single.php?post_id=$post_id'><button>See Replies or Reply to This</button></a>
		</div><br/>
		";
	...
	$row_posts=mysqli_fetch_array($run_posts);
		...
		<textarea cols='80' rows='5' name='comment' placeholder='write your reply'></textarea><br/>
	...
	while($row_posts=mysqli_fetch_array($run_posts)){
		...
		<p>$post_date</p>
		<p>$content</p>
		<a href='single.php?post_id=$post_id' ><button>View</button></a>
